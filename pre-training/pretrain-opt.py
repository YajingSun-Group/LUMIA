...
def main():
    ...
    # load graph data
    if args.graph_data_path is not None:
        graph_data = dgl.load_graphs(args.graph_data_path)
        logger.info(f"{args.graph_data_path} graph data loaded, shape: {graph_data.shape}")
