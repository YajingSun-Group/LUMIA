...
class BaseGNN(nn.Module):
    ...
    def forward(self, rgcn_bg, rgcn_node_feats, rgcn_edge_feats, smask_feats,additional_features):
        # 将分子特征移动到正确的设备
        ...
        if self.embed_molecular_features:
            molecular_features = self.molcular_features_embedding(additional_features)
